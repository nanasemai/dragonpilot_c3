...
typedef struct UIScene {
  ...
  bool long_pid_override;

  // UI显示设置
  bool dp_show_date_time = false;
  bool dp_hide_ui = false;
  bool dp_lon_acm = false;

  // 调参参数
  std::string dp_torque_lat_accel_factor;
  std::string dp_torque_friction;
  std::string dp_lateral_torque_kp;
  std::string dp_lateral_torque_ki;
  std::string dp_long_pid_kp;
  std::string dp_long_pid_ki;
} UIScene;
